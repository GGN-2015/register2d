...
if __name__ == "__main__":
    ...
    # 请根据你的需求修改这3个参数
    INPUT_IMAGE_PATH = "all_data/data2/image_part1.png"    # 输入图片路径（支持jpg、png、bmp等格式）
    OUTPUT_IMAGE_PATH = "all_data/data2/image_part3.png"  # 输出图片路径（建议用png格式，避免压缩失真）
    ROTATE_ANGLE = 172.4               # 逆时针旋转角度（例如：30、45、90、120.5等）
